...
public class StatementSpy implements Statement, Spy
{
	...
	public int executeUpdate(String sql, String[] columnNames) throws SQLException
	{
		...
		Span span = Utilities.startSpan("executeUpdate", sql);
		try
		{
	...
	public boolean execute(String sql, String[] columnNames) throws SQLException
	{
		...
		reportStatementSql(sql, methodCall);
		long tstart = System.currentTimeMillis();
		Span span = Utilities.startSpan("execute", sql);
		try
		{
	...
	public int[] executeBatch() throws SQLException
	{
		...
		int[] updateResults;
		Span span = Utilities.startSpan("executeBatch", sql);
		try
		{
	...
	public ResultSet executeQuery(String sql) throws SQLException
	{
		...
		reportStatementSql(sql, methodCall);
		long tstart = System.currentTimeMillis();
		Span span = Utilities.startSpan("executeQuery", sql);
		try
		{
