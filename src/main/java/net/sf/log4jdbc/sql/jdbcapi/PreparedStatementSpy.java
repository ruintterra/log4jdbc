...
public class PreparedStatementSpy extends StatementSpy implements PreparedStatement
{
  ...
  public boolean execute() throws SQLException
  {
    ...
    Span span = Utilities.startSpan("execute", dumpedSql);
    try
    {
  ...
  public ResultSet executeQuery() throws SQLException
  {
    ...
    reportSql(dumpedSql, methodCall);
    long tstart = System.currentTimeMillis();
    Span span = Utilities.startSpan("executeQuery", dumpedSql);
    try
    {
  ...
  public int executeUpdate() throws SQLException
  {
    ...
    reportSql(dumpedSql, methodCall);
    long tstart = System.currentTimeMillis();
    Span span = Utilities.startSpan("executeUpdate", dumpedSql);
    try
    {
